          ...
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              ...
              <div className="relative">
                ...
                <div className="flex items-center justify-end gap-4 mt-4"><div className="flex items-center border-2 border-gray-600 rounded-md px-2 py-1 bg-white"><button onClick={() => setDubaiQty(Math.max(0, dubaiQty - 1))} className="w-6 h-6 rounded bg-gray-100 font-bold">-</button><span className="px-3 font-bold">{dubaiQty}</span><button onClick={() => setDubaiQty(dubaiQty + 1)} className="w-6 h-6 rounded bg-green-400 text-white font-bold">+</button></div><button onClick={() => alert('Added to cart!')} className="bg-[#ef3232] hover:bg-[#d41313] text-white font-bold px-6 py-2 rounded-lg">ADD TO CART</button></div>
              </div>
            </div>

...
export default function Tickets() {
  ...
  return (
    <div className="bg-gradient-to-b from-blue-100 to-blue-10 min-h-screen">
      ...
      {/* DUBAI TRIP */}
      {tickets.filter(tri => tri.name === "Dubai").map(tric => (
        <section key={tric.id} className="bg-[#edf8fd] py-10">
          <div className="container mx-auto px-4 max-w-5xl">
                ...
                <div className="absolute z-30 p-6 w-full h-full flex flex-col justify-between text-white">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="text-right">
                      <div className="font-berlin text-5xl font-bold">{tric.name}</div>
                  ...
                  <div className="flex justify-between items-end">
                    <div>
                      <div className="flex items-end gap-1 mb-2">
                        ...
                        <span className="font-berlin text-5xl font-bold text-yellow-400">{tric.price}</span>
                      ...
                      <p className="font-montserrat text-xs">Draw Date: {new Date(tric.date).toLocaleDateString()}<br />earlier if sold out</p>
                    </div>
                    <div className="text-right">
                      <span className="font-montserrat text-xs font-bold block">Total Tickets</span>
                      <span className="font-berlin text-5xl font-bold text-yellow-300 block">{tric.ticket}</span>
                      <button className="font-montserrat mt-2 bg-[#ef3232] hover:bg-[#d32c2c] text-white font-bold text-sm px-4 py-2 rounded-lg">BUY TICKET</button>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center justify-end gap-4 mt-4">
                  <div className="flex items-center border-2 border-gray-600 rounded-md px-2 py-1 bg-white">
                    <button
                      ...
                      className="font-montserrat w-6 h-6 rounded bg-gray-100 font-bold"
                    >
                      -
                    </button>
                    <span className="font-montserrat px-3 font-bold">{dubaiQty}</span>
                    <button
                  ...
                  <button
                    ...
                    className="font-montserrat bg-[#ef3232] hover:bg-[#d41313] text-white font-bold px-6 py-2 rounded-lg"
                  >
                    ADD TO CART
                  </button>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-3 mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="font-montserrat text-sm text-gray-700">3 Star hotel for 2 nights with breakfast</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-6 h-6 rounded-full bg-green-500 flex items-center justify-center flex-shrink-0">
                  <Check className="w-4 h-4 text-white" />
                </div>
                <span className="font-montserrat text-sm text-gray-700">Basic City Tour</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-6 h-6 rounded-full bg-red-500 flex items-center justify-center flex-shrink-0">
                  <X className="w-4 h-4 text-white" />
                </div>
                <span className="font-montserrat text-sm text-gray-700">Lunch, Dinner and Alcohol</span>
              </div>
            </div>
      ...
      {/* THAILAND TRIP */}
      {tickets.filter(tri => tri.name === "Thailand").map(tric => (
        <section key={tric.id} className="bg-[#edf8fd] py-10">
          <div className="container mx-auto px-4 max-w-5xl">
            <h1 className="font-berlin text-4xl font-bold text-[#ef3232] mb-6 uppercase">Thailand Trip</h1>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div className="relative bg-white rounded-3xl overflow-hidden shadow-md h-80">
                ...
                <div className="absolute z-30 p-6 w-full h-full flex flex-col justify-between text-white">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="text-right">
                      <div className="font-berlin text-5xl font-bold">{tric?.name}</div>
                      <span className="font-montserrat inline-block bg-lime-300 text-gray-900 font-semibold py-1 px-3 rounded-lg text-sm mt-2">{tric?.description}</span>
                    </div>
                  </div>
                  <div className="flex justify-between items-end">
                    <div>
                      ...
                      <p className="font-montserrat text-xs">Draw Date: {new Date(tric?.date).toLocaleDateString()} or<br />earlier if sold out</p>
                    </div>
                    <div className="text-right">
                      <span className="font-montserrat text-xs font-bold block">Total Tickets</span>
                      <span className="font-berlin text-5xl font-bold text-yellow-300 block">{tric?.ticket}</span>
              ...
              <div className="relative">
                ...
                <div className="flex items-center justify-end gap-4 mt-4">
                  <div className="flex items-center border-2 border-gray-600 rounded-md px-2 py-1 bg-white">
                    ...
                    <span className="font-montserrat px-3 font-bold">{thailandQty}</span>
                    <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-3 mb-8">
              <div className="flex items-center gap-3">
                ...
                <span className="font-montserrat text-sm text-gray-700">Return Ticket from India to Thailand</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-6 h-6 rounded-full bg-green-500 flex items-center justify-center flex-shrink-0">
                  <Check className="w-4 h-4 text-white" />

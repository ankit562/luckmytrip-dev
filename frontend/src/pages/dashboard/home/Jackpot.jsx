...
export default function Jackpot() {
  ...
  function onConfirmEdit() {
    if (editId === null) {
      ...
      setJourneys([...journeys, { id: newId, ...editData, image: null }]);
    } else {
      // Update existing
      setJourneys(
        journeys.map(j =>
          j.id === editId ? { ...j, name: editData.name, content: editData.content, imageUrl: editData.imageUrl } : j
        )
      );
    }
    onCancelEdit();
...
<div className="min-h-screen bg-blue-50 flex flex-col px-8 py-2 ">
      <h1 className="text-3xl font-bold text-black mb-6">Jackpot</h1>
      ...
      <div className="flex justify-start items-center px-5 py-2 bg-blue-500 text-white rounded hover:bg-blue-700 max-w-36 mb-2 gap-1">
        ...
        className="text-end">Add Field </button>
        </div>  
      ...
      {/* Table */}
        ...
        <thead>
          <tr className="bg-gray-100">
            ...
            <th className="p-3 text-left">Ticket Info.</th>
        ...
        <tbody>
          {journeys.map(row => (
            <tr key={row.id} className="border-t hover:bg-gray-50">
              ...
              <td className="p-3 max-w-md truncate">{row.content}</td>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
          <div className="bg-white rounded shadow-lg p-6 w-full max-w-md relative">
            ...
            >
              ...
              <div>
                <label className="block mb-1 font-medium">Ticket Info.</label>
                <textarea
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
          <div className="bg-white rounded shadow-lg p-6 w-full max-w-sm">
            ...
            <p className="mb-6">Are you sure you want to delete this jackpot field?</p>
            <div className="flex justify-end space-x-3">
              <button
